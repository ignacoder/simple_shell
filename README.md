...
This was an ALX project collaboration work on shell. In this project we were asked to create a simple shell that mimics the Bash shell. This project was completed using the C programming language.
